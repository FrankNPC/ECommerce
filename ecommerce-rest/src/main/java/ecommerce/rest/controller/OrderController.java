...
public class OrderController {
	...
	public String create(@RequestParam(value = "callback", defaultValue = "") String callback,
		...
		List<Long> prodIdList = Arrays.stream(productIds.split(",")).map(str -> Long.parseLong(str))
				.collect(Collectors.toList());
		List<Long> quantiList = Arrays.stream(quantities.split(",")).map(str -> Long.parseLong(str))
				.collect(Collectors.toList());
	...
	public String query(@RequestParam(value = "callback", defaultValue = "") String callback,
			@RequestParam(value = "session_id", defaultValue = "") String sessionId,
	...
	public String payment(@RequestParam(value = "callback", defaultValue = "") String callback,
			@RequestParam(value = "id", defaultValue = "") String id,
		...
		if (orderResult.getCode() != Result.Code.OK.value
				|| orderResult.getData().getStatus() != Order.Status.Actived.value) {
	...
	public String refund(@RequestParam(value = "callback", defaultValue = "") String callback,
			@RequestParam(value = "session_id", defaultValue = "") String sessionId,
			@RequestParam(value = "id", defaultValue = "") String id,
			@RequestParam(value = "token", defaultValue = "") String token) {
		logger.info(String.format("[%s][%s][%s][%s]", callback, token, sessionId, id));
	...
	public String close(@RequestParam(value = "callback", defaultValue = "") String callback,
			@RequestParam(value = "session_id", defaultValue = "") String sessionId,
			@RequestParam(value = "id", defaultValue = "") String id,
			@RequestParam(value = "token", defaultValue = "") String token) {
		logger.info(String.format("[%s][%s][%s][%s]", callback, token, sessionId, id));
