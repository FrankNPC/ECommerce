...
public class UserController {
	...
	public String login(@RequestParam(value = "callback", defaultValue = "") String callback,
			@RequestParam(value = "username", defaultValue = "") String username,
			@RequestParam(value = "password", defaultValue = "") String password,
			@RequestParam(value = "token", defaultValue = "") String token) {
		logger.info(String.format("[%s][%s][%s][%s]", callback, token, username, password));
	...
	public String reset(@RequestParam(value = "callback", defaultValue = "") String callback,
	...
	public String modify(@RequestParam(value = "callback", defaultValue = "") String callback,
			@RequestParam(value = "password", defaultValue = "") String password,
			@RequestParam(value = "session_id", defaultValue = "") String sessionId,
			@RequestParam(value = "token", defaultValue = "") String token) {
	...
	public String remove(@RequestParam(value = "callback", defaultValue = "") String callback,
			@RequestParam(value = "session_id", defaultValue = "") String sessionId,
			@RequestParam(value = "token", defaultValue = "") String token) {
		logger.info(String.format("[%s][%s][%s]", callback, token, sessionId));
